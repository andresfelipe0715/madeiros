    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h4 font-weight-bold mb-0">
                {{ __('Historial de Movimientos de Materiales') }}
                @if($material)
            ...
            <div class="d-flex gap-2">
                @if($material)
                    <a href="{{ route('materials.logs.all') }}" class="btn btn-outline-primary">
                        {{ __('Ver Todo el Historial') }}
                    </a>
                @endif
                <a href="{{ route('materials.index') }}" class="btn btn-secondary">
                    {{ __('Volver a Materiales') }}
                </a>
            </div>
        </div>
    </x-slot>
