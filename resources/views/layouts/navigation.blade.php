<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex min-w-0">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex overflow-x-auto scrollbar-hide flex-nowrap min-w-0">
                    ...
                    @can('view-materials')
                        <div class="hidden sm:flex sm:items-center sm:ms-4">
                            <x-dropdown align="left" width="48">
                                <x-slot name="trigger">
                                    <button
                                        class="inline-flex items-center px-1 pt-1 border-b-2 {{ request()->routeIs('materials.*') ? 'border-indigo-400 text-gray-900 font-medium' : 'border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300' }} focus:outline-none transition duration-150 ease-in-out">
                                        <div>{{ __('Materiales') }}</div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800">{{ Str::limit(Auth::user()->name, 30) }}</div>
                <div class="font-medium text-sm text-gray-500">{{ Auth::user()->document }}</div>
            </div>
